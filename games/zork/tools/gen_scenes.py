...
PROPS_DEF = {
    ...
    "actor_cyclops": [("box", (1.5, 2.6, 1.1), (0.55, 0.45, 0.35), 1.3, 0), ("sphere", (0.6,), (0.6, 0.5, 0.4), 3.0, 0), ("sphere", (0.18,), (0.9, 0.9, 0.3), 3.1, 0.8)],
...
ROOMS = {
    ...
    "cyclops_room":   dict(size=(15, 15), kind="interior", wall=(0.3, 0.22, 0.2), floor=(0.24, 0.18, 0.16), height=5.0),
}
