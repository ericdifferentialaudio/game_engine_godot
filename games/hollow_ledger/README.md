...
Validate: `python tools/validate_data.py games/hollow_ledger`
Run:      `tools/godot.ps1 run hollow_ledger`    Smoke test: `tools/godot.ps1 smoke hollow_ledger`
